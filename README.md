...
- I have automated the process of creating an instance and starting the Minecraft server via two files in this repo:
  1. **main.tf**
     ...
     - Terraform is an Infrastructure as Code (IaC) tool.
       - IaC tools like Terraform allow us to define and provision infrastructure such as EC2 instances with code files rather than doing it manually.
...
- First, open a Powershell instance as an administrator.
...
- At the bottom of the command output, you should see something like:
    ...
    ```
- Copy your ```instance_ip``` value from the ```terraform apply``` output.
...
3. Select the **Add a Server** option.
